...
class Task(models.Model):
    ...
    create_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True,
                                  null=True, related_name='+')
    employee_code = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                                      blank=True, null=True, related_name='+')
    employee_test = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                                      blank=True, null=True, related_name='+')
